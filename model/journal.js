...
// Journal Type Report
journalSchema.index({ journalType: 1  });
...
journalSchema.index({ journalType: 1, postingStatus: 1  });
journalSchema.index({ journalDate: -1, postingStatus: 1  });
...
journalSchema.statics.getAllJournals = function() {
...
journalSchema.statics.getPendingApproval = function() {
...
journalSchema.statics.getPostedJournals = function() {
...
journalSchema.statics.getMonthlyReport = function(month, year) {
