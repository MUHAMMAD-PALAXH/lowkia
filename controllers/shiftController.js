...
exports.createShift = asyncHandler(async (req, res) => {
    const doc = await shiftService.createShift(
        req.body,
        getActorId(req),
        req.companyId
    );
...
exports.getShifts = asyncHandler(async (req, res) => {
    const result = await shiftService.getShifts(req.query, req.companyId);
    return success(res, "Shifts retrieved.", result);
});

exports.getActiveShifts = asyncHandler(async (req, res) => {
    const items = await shiftService.getActiveShifts(req.companyId);
    return success(res, "Active shifts retrieved.", items);
});

exports.getShiftById = asyncHandler(async (req, res) => {
    const doc = await shiftService.getShiftById(req.params.id, req.companyId);
...
exports.deleteShift = asyncHandler(async (req, res) => {
    const doc = await shiftService.deleteShift(
        req.params.id,
        getActorId(req),
        req.companyId
    );
...
exports.restoreShift = asyncHandler(async (req, res) => {
    const doc = await shiftService.restoreShift(
        req.params.id,
        getActorId(req),
        req.companyId
    );
...
exports.permanentDeleteShift = asyncHandler(async (req, res) => {
    const result = await shiftService.permanentDeleteShift(
        req.params.id,
        req.companyId
    );
